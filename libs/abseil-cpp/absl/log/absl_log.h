...
#define ABSL_LOG(severity) std::cout //ABSL_LOG_INTERNAL_LOG_IMPL(_##severity)
#define ABSL_PLOG(severity) std::cout //ABSL_LOG_INTERNAL_PLOG_IMPL(_##severity)
#define ABSL_DLOG(severity) std::cout //ABSL_LOG_INTERNAL_DLOG_IMPL(_##severity)

#define ABSL_VLOG(verbose_level) std::cout //ABSL_LOG_INTERNAL_VLOG_IMPL(verbose_level)
#define ABSL_DVLOG(verbose_level) std::cout //ABSL_LOG_INTERNAL_DVLOG_IMPL(verbose_level)
